...
public class FloatBuffer extends Buffer
{
	...
	static final boolean method2249(Class123 class123, int i) throws IOException {
		...
		if (Class338.aClass192_4201 == class123.aClass192_1576) {
			Class173.aString2085 = class123.anInt1581 <= 2 ? Class22.aClass22_389.method297(-12273, Class35.anInt537) : packet.method2195(-1);
		...
		if (class123.aClass192_1576 == Class168.aClass192_2045) {
			while (class123.anInt1581 > packet.anInt7002) {
				...
				boolean bool_40_ = packet.method2233(255) == 1;
				String string_41_ = "";
				boolean bool_42_ = false;
				if (i_38_ > 0) {
					string_41_ = packet.method2195(-1);
					bool_42_ = packet.method2233(255) == 1;
				}
			...
			while (i_45_ > 0) {
				...
				for (int i_46_ = 0; i_46_ < i_45_; i_46_++) {
					...
					if (Class202.anIntArray2448[i_46_] != Class181.aClass197_2155.worldId && Class181.aClass197_2155.worldId == Class202.anIntArray2448[1 + i_46_]) {
						bool_47_ = true;
					}
